...
if (strlen($_SESSION['remsuid'] == 0)) {
    ...
    if (isset($_POST['submit'])) {
        ...
        if (!in_array($extension1, $allowed_extensions)) {
            ...
            $query = mysqli_query($con, "update tblproperty set GalleryImage1='$propic1' where ID='$cid'");
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-4 col-sm-4 col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <img src="propertyimages/<?php echo $row['GalleryImage1']; ?>" width="200" height="150">
                                                </div>
                                            </div>
                                            <div class="col-xs-4 col-sm-4 col-md-4">
                                                <div class="form-group">
