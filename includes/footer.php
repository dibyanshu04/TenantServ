 ...
 <footer id="footer" class="footer footer-1 bg-white">
    ...
    ============================================= -->
     <div class="footer-widget">
         <div class="container">
             <div class="row">
                 <div class="col-lg-4 col-md-3 widget--about">
                         ...
                         <?php
                            ...
                            ?>
                             <div class="footer--logo">
                                 <img src="assets/images/logo/logo11.png" alt="logo" width="60%">
                             </div>
                 ...
                 <!-- .col-md-2 end -->
                 <div class=" col-lg-2 col-md-3 widget--links">
                 ...
                 <div class=" col-lg-2 col-md-3 widget--links">
                     ...
                     <div class="widget--content">
                         <ul class="list-unstyled mb-0">
                           <li><a href="https://www.facebook.com"  target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
                           ...
                           <li><a href="https://www.twitter.com"  target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-twitter" viewBox="0 0 16 16">
                 ...
                 @media (min-width: 900px){ {visibility: hidden}}">
                 <div class="vr"></div>
                 </div> -->
                 
                 <div class="col-lg-2 col-md-3">
                   <p>Flats, Houses, Apartments in no time</p>
                   <p>CALL US AT XXXXXXXX</p>
                 </div>
     ...
     <div class="footer--copyright text-center">
         <div class="container">
             <div class="row footer--bar" style="background-color: #e8e8e8; border-radius: 100%;  padding: 6px 8px; margin: 0px 20px 30px;">
                 ...
                 <div class="col-md-6" >
                     <span>Developed by Kaplin Technology</span>
                 </div>
