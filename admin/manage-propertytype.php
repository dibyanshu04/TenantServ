...
?>
    ...
    <head>
        ...
        <title>Real Estate Management System || Manage Property Type</title>
        <!-- Bootstrap CSS -->
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered first">
                                            ...
                                            <tbody>
                                                <?php
                                                $ret = mysqli_query($con, "select *from tblpropertytype");
                                                $cnt = 1;
                                                ...
                                                ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="edit-propertytype.php?editid=<?php echo $row['ID']; ?>">Edit Details</a></td>
                                                    </tr>
                                                <?php
                                                    $cnt = $cnt + 1;
                                                } ?>
