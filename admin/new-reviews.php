...
?>
    ...
    <head>
        ...
        <title>Real Estate Management System || Manage City</title>
        <!-- Bootstrap CSS -->
                                                ...
                                                ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="new-reviews.php?rid=<?php echo $row['rid']; ?>" onclick="return confirm('Do you really want to Approve this review ?')">Approve</a> |
                                                            <a href="new-reviews.php?delrid=<?php echo $row['rid']; ?>" onclick="return confirm('Do you really want to delete ?')>">Delete</a>
                                                        </td>
                                                    </tr>
                                                <?php
                                                    $cnt = $cnt + 1;
