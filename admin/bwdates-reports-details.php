...
?>
    ...
    <head>
        ...
        <title>Real Estate Management System || B/W date Reports</title>
        <!-- Bootstrap CSS -->
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered first">
                                            ...
                                            <tbody>
                                                <?php
                                                $ret = mysqli_query($con, "select * from tblproperty join tbluser on tbluser.ID=tblproperty.UserID where date(tblproperty.ListingDate) between '$fdate' and '$tdate'");
                                                $cnt = 1;
