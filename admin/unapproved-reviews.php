...
?>
    ...
    <head>
        ...
        <title>Real Estate Management System || Manage Reviews</title>
        <!-- Bootstrap CSS -->
                                ...
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">Unapproved Reviews</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="view-users-details.php?viewid=<?php echo $row['uid']; ?>"><?php echo $row['FullName']; ?></a>
                                                        </td>
                                                        ...
                                                        <td><a href="unapproved-reviews.php?rid=<?php echo $row['rid']; ?>" onclick="return confirm('Do you really want to Approve this review ?')">Approve</a> |
                                                            <a href="unapproved-reviews.php?delrid=<?php echo $row['rid']; ?>" onclick="return confirm('Do you really want to delete ?')>">Delete</a>
                                                        </td>
                                                    </tr>
                                                <?php
                                                    $cnt = $cnt + 1;
